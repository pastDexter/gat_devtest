...
describe 'V1 Private Locations', type: :request do
  ...
  let(:country2) { create(:country, panel_provider: panel_provider2, country_code: 'EN') }
  ...
  describe 'GET #index' do
    ...
    context 'with valid token' do
      context 'with valid country_code' do
        before { get_with_token("/v1/private/locations/#{country1.country_code}", token) }
      ...
      context 'with invalid country code' do
        it 'returns 404 status code' do
          get_with_token('/v1/private/locations/XX', token)
